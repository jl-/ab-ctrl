...
/***/ function(module, exports, __webpack_require__) {
	...
	var _singleton = __webpack_require__(246);
	...
	var _popup = __webpack_require__(267);
	...
	function genTooltip(align, trigger) {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      _tooltip2.default.Trigger,
	      null,
	      trigger
	    ),
	    _react2.default.createElement(
	      _tooltip2.default.Content,
	      { align: align },
	      _react2.default.createElement(
	        'mark',
	        null,
	...
	var Demo = function (_Component) {
	  ...
	  function Demo(props, context) {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Demo).call(this, props, context));
	  }
	  ...
	  (0, _createClass3.default)(Demo, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'span',
	                  { className: 'tooltip-item', 'data-tooltip': 'Tooltip content', 'data-tooltip-align': 'tc' },
	                  'top center'
	                ),
	                _react2.default.createElement(
	                  'span',
	                  { className: 'tooltip-item', 'data-tooltip': 'Tooltip content', 'data-tooltip-align': 'bc' },
	                  'bottom center'
	                ),
	                _react2.default.createElement(
	                  'span',
	                  { className: 'tooltip-item', 'data-tooltip': 'Tooltip content', 'data-tooltip-align': 'lc' },
	                  'left center'
	                ),
	                _react2.default.createElement(
	                  'span',
	                  { className: 'tooltip-item', 'data-tooltip': 'Tooltip content', 'data-tooltip-align': 'rc' },
	                  'right center'
	                )
	              ),
	              _react2.default.createElement(
	        ...
	        _react2.default.createElement(_singleton2.default, null)
	      );
	    }
	  }]);
	  return Demo;
	...
	_reactDom2.default.render(_react2.default.createElement(Demo, null), document.querySelector('#demo'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TOOLTIP_ACTIVE_CLS = 'tp--active';

	var $tooltip = null;
	function makeTooltip(content) {
	  var tooltipInner = void 0;
	  if (!$tooltip) {
	...
	function getTooltipData(target) {
	  ...
	  var align = target.getAttribute('data-tooltip-align');
	  return { content: content, align: align };
	}
	...
	function showTooltipForTarget(target) {
	  var tooltipData = getTooltipData(target);
	  var content = tooltipData && tooltipData.content;
	  if (!target || !content || isTooltipShown(target)) return;

	  var align = tooltipData.align;
	  var tooltip = makeTooltip(content);

	  target.insertAdjacentElement('afterend', tooltip);

	  var _computeTooltipStyle = computeTooltipStyle(target, tooltip, align);

	  var left = _computeTooltipStyle.left;
	  var top = _computeTooltipStyle.top;
	...
	function computeTooltipStyle(target, tooltip, align) {
	  ...
	  var _window = window;
	  var winWidth = _window.innerWidth;
	  var winHeight = _window.innerHeight;
	  var _document$body = document.body;
	  var winScrollLeft = _document$body.scrollLeft;
	  var winScrollTop = _document$body.scrollTop;


	  var baseLeft = targetOffsetLeft,
	      baseTop = targetOffsetTop;

	  var leftForVerticalCenter = baseLeft + (targetWidth - tooltipWidth) / 2;
	  var topForHorizontalCenter = baseTop + (targetHeight - tooltipHeight) / 2;
	  var leftForToLeft = baseLeft - tooltipWidth;
	  var leftForToRight = baseLeft + targetWidth;
	  var topForToBottom = baseTop + targetHeight;
	  var topForToTop = baseTop - tooltipHeight;
	  ...
	  for (var index = pos.length - 1; index > 0; index -= 2) {
	    var isPosVisible = isTopValid(pos[index], tooltipHeight, winScrollTop, winHeight) && isLeftValid(pos[index - 1], tooltipWidth, winScrollLeft, winWidth);
	...
	var Tooltip = function (_Component) {
	  ...
	  function Tooltip(props, context) {
	    ...
	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Tooltip).call(this, props, context));
	  ...
	  (0, _createClass3.default)(Tooltip, [{
	    ...
	    value: function handleMouseOver(e) {
	      ...
	      var fromTarget = findTooltipTarget(relatedTarget);
	      var toTarget = findTooltipTarget(target);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?importLoaders=1!./../../node_modules/sass-loader/index.js!./style.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?importLoaders=1!./../../node_modules/sass-loader/index.js!./style.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extends2 = __webpack_require__(252);
	...
	var Tooltip = function (_Component) {
	  ...
	  (0, _createClass3.default)(Tooltip, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(_index2.default, (0, _extends3.default)({ triggerType: 'hover', interactive: false }, this.props, { variant: 'tooltip' }));
	    }
	  }]);
	  return Tooltip;
	}(_react.Component);

	Tooltip.Trigger = _index2.default.Trigger;
	Tooltip.Content = _index2.default.Content;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _trigger = __webpack_require__(261);

	var _trigger2 = _interopRequireDefault(_trigger);

	var _content = __webpack_require__(262);

	var _content2 = _interopRequireDefault(_content);

	var _domContains = __webpack_require__(263);
	...
	var TRIGGER_REF = (0, _symbol2.default)('trigger'); /**
	...
	var ABCtrl = function (_Component) {
	  (0, _inherits3.default)(ABCtrl, _Component);

	  function ABCtrl(props, context) {
	    (0, _classCallCheck3.default)(this, ABCtrl);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ABCtrl).call(this, props, context));

	    _this.state = { active: props.active };
	    return _this;
	  }

	  (0, _createClass3.default)(ABCtrl, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      this.setBlurHandler();
	    }
	    ...
	    key: 'setBlurHandler',
	    value: function setBlurHandler() {
	      var _this2 = this;

	      var props = arguments.length <= 0 || arguments[0] === undefined ? this.props : arguments[0];

	      var donSet = props.ignoreBlur === true || props.triggerType !== 'click' || typeof this.unsetBlurHandler === 'function';
	      if (donSet) return;

	      var handler = function handler(e) {
	        var shouldDeactivate = _this2.state.active && !(0, _domContains2.default)(_reactDom2.default.findDOMNode(_this2), e.target);
	        shouldDeactivate && _this2.toggle(false);
	      };
	      document.addEventListener('click', handler);
	      this.unsetBlurHandler = function () {
	    ...
	    value: function toggle() {
	      var active = arguments.length <= 0 || arguments[0] === undefined ? !this.state.active : arguments[0];
	    ...
	    value: function render() {
	      ...
	      var _props$triggerType = _props.triggerType;
	      var triggerType = _props$triggerType === undefined ? 'hover' : _props$triggerType;
	      var _props$toggleable = _props.toggleable;
	      var toggleable = _props$toggleable === undefined ? true : _props$toggleable;
	      var _props$interactive = _props.interactive;
	      var interactive = _props$interactive === undefined ? true : _props$interactive;
	      var _props$variant = _props.variant;
	      var variant = _props$variant === undefined ? 'ab-ctrl' : _props$variant;
	      var className = _props.className;
	      var children = _props.children;
	      var _props$component = _props.component;
	      var component = _props$component === undefined ? 'div' : _props$component;
	      var onActive = _props.onActive;
	      var onInactive = _props.onInactive;
	      var props = (0, _objectWithoutProperties3.default)(_props, ['triggerType', 'toggleable', 'interactive', 'variant', 'className', 'children', 'component', 'onActive', 'onInactive']);
	      var active = this.state.active;

	      var inner = _react.Children.map(children, function (child) {
	        if (!child || child.type !== _trigger2.default && child.type !== _content2.default) return child;
	        var _child$props = child.props;
	        var onClick = _child$props.onClick;
	        var handleContentClick = _child$props.handleContentClick;
	        var childProps = (0, _objectWithoutProperties3.default)(_child$props, ['onClick', 'handleContentClick']);

	        if (child.type === _content2.default) {
	          (function () {
	            var clickHandler = handleContentClick || onClick;
	            childProps.className = (0, _classnames2.default)(childProps.className, variant + '-content', variant + '-content--' + (childProps.align || 'bc'));
	            childProps.onClick = function (e) {
	              var shouldDeactivate = typeof clickHandler === 'function' ? clickHandler(e) !== false : !interactive;
	              shouldDeactivate && _this3.toggle(false);
	            };
	          })();
	        } else if (child.type === _trigger2.default) {
	          childProps.className = (0, _classnames2.default)(childProps.className, variant + '-trigger');
	          ...
	          if (triggerType === 'click') {
	            ...
	            var triggerHolder = interactive ? props : childProps;
	            triggerHolder.onMouseEnter = function () {
	              return _this3.toggle(true);
	            };
	            triggerHolder.onMouseLeave = function () {
	      ...
	      props.className = (0, _classnames2.default)((_cx = {}, (0, _defineProperty3.default)(_cx, variant + '--active', active), (0, _defineProperty3.default)(_cx, variant + '--inactive', !active), _cx), className, variant);
	      return _react2.default.createElement(component, props, inner);
	    }
	  }]);
	  return ABCtrl;
	}(_react.Component);

	ABCtrl.Trigger = _trigger2.default;
	ABCtrl.Content = _content2.default;

	exports.default = ABCtrl;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ABCtrlTrigger = function (_Component) {
	  (0, _inherits3.default)(ABCtrlTrigger, _Component);

	  function ABCtrlTrigger() {
	    (0, _classCallCheck3.default)(this, ABCtrlTrigger);
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ABCtrlTrigger).apply(this, arguments));
	  }

	  (0, _createClass3.default)(ABCtrlTrigger, [{
	    key: 'render',
	    value: function render() {
	      var _props = this.props;
	      var _props$component = _props.component;
	      var component = _props$component === undefined ? 'div' : _props$component;
	      var children = _props.children;
	      var props = (0, _objectWithoutProperties3.default)(_props, ['component', 'children']);

	      return _react2.default.createElement(component, props, children);
	    }
	  }]);
	  return ABCtrlTrigger;
	}(_react.Component);

	exports.default = ABCtrlTrigger;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ABCtrlContent = function (_Component) {
	  (0, _inherits3.default)(ABCtrlContent, _Component);

	  function ABCtrlContent() {
	    (0, _classCallCheck3.default)(this, ABCtrlContent);
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ABCtrlContent).apply(this, arguments));
	  }

	  (0, _createClass3.default)(ABCtrlContent, [{
	    key: 'render',
	    value: function render() {
	      var _props = this.props;
	      var _props$component = _props.component;
	      ...
	      var children = _props.children;
	      var props = (0, _objectWithoutProperties3.default)(_props, ['component', 'align', 'children']);

	      return _react2.default.createElement(component, props, children);
	    }
	  }]);
	  return ABCtrlContent;
	}(_react.Component);

	exports.default = ABCtrlContent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".ab-ctrl {\n  position: relative; }\n  .ab-ctrl-trigger {\n    cursor: pointer; }\n  .ab-ctrl-content {\n    position: absolute;\n    border-radius: 0.2em;\n    padding: 0.4em 0;\n    z-index: 11;\n    box-shadow: 0 3px 8px rgba(0, 0, 0, 0.25), 0 0 1px rgba(0, 0, 0, 0.37);\n    white-space: nowrap; }\n    .ab-ctrl-content--bc {\n      min-width: 100%;\n      top: 100%;\n      left: 50%;\n      transform: translate(-50%, 0); }\n    .ab-ctrl-content--br {\n      right: 0; }\n    .ab-ctrl-content--tc {\n      bottom: 100%;\n      left: 50%;\n      transform: translate(-50%, 0); }\n    .ab-ctrl-content--lc {\n      right: 100%;\n      top: 50%;\n      transform: translate(0, -50%); }\n    .ab-ctrl-content--rc {\n      left: 100%;\n      top: 50%;\n      transform: translate(0, -50%); }\n  .ab-ctrl--inactive .ab-ctrl-content {\n    display: none; }\n  .ab-ctrl--light .ab-ctrl-content {\n    background-color: white; }\n\n.dropdown {\n  position: relative; }\n  .dropdown-trigger {\n    cursor: pointer; }\n  .dropdown-content {\n    position: absolute;\n    border-radius: 0.2em;\n    padding: 0.4em 0;\n    z-index: 11;\n    box-shadow: 0 3px 8px rgba(0, 0, 0, 0.25), 0 0 1px rgba(0, 0, 0, 0.37);\n    white-space: nowrap; }\n    .dropdown-content--bc {\n      min-width: 100%;\n      top: 100%;\n      left: 50%;\n      transform: translate(-50%, 0); }\n    .dropdown-content--br {\n      right: 0; }\n    .dropdown-content--tc {\n      bottom: 100%;\n      left: 50%;\n      transform: translate(-50%, 0); }\n    .dropdown-content--lc {\n      right: 100%;\n      top: 50%;\n      transform: translate(0, -50%); }\n    .dropdown-content--rc {\n      left: 100%;\n      top: 50%;\n      transform: translate(0, -50%); }\n  .dropdown--inactive .dropdown-content {\n    display: none; }\n  .dropdown--light .dropdown-content {\n    background-color: white; }\n  .dropdown-content {\n    background-color: white; }\n    .dropdown-content--bc, .dropdown-content--br, .dropdown-content--bl {\n      margin-top: 2px; }\n  .dropdown-trigger {\n    user-select: none; }\n\n.popup {\n  position: relative; }\n  .popup-trigger {\n    cursor: pointer; }\n  .popup-content {\n    position: absolute;\n    border-radius: 0.2em;\n    padding: 0.4em 0;\n    z-index: 11;\n    box-shadow: 0 3px 8px rgba(0, 0, 0, 0.25), 0 0 1px rgba(0, 0, 0, 0.37);\n    white-space: nowrap; }\n    .popup-content--bc {\n      min-width: 100%;\n      top: 100%;\n      left: 50%;\n      transform: translate(-50%, 0); }\n    .popup-content--br {\n      right: 0; }\n    .popup-content--tc {\n      bottom: 100%;\n      left: 50%;\n      transform: translate(-50%, 0); }\n    .popup-content--lc {\n      right: 100%;\n      top: 50%;\n      transform: translate(0, -50%); }\n    .popup-content--rc {\n      left: 100%;\n      top: 50%;\n      transform: translate(0, -50%); }\n  .popup--inactive .popup-content {\n    display: none; }\n  .popup--light .popup-content {\n    background-color: white; }\n\n.tooltip {\n  position: relative; }\n  .tooltip-trigger {\n    cursor: pointer; }\n  .tooltip-content {\n    position: absolute;\n    border-radius: 0.2em;\n    padding: 0.4em 0;\n    z-index: 11;\n    box-shadow: 0 3px 8px rgba(0, 0, 0, 0.25), 0 0 1px rgba(0, 0, 0, 0.37);\n    white-space: nowrap; }\n    .tooltip-content--bc {\n      min-width: 100%;\n      top: 100%;\n      left: 50%;\n      transform: translate(-50%, 0); }\n    .tooltip-content--br {\n      right: 0; }\n    .tooltip-content--tc {\n      bottom: 100%;\n      left: 50%;\n      transform: translate(-50%, 0); }\n    .tooltip-content--lc {\n      right: 100%;\n      top: 50%;\n      transform: translate(0, -50%); }\n    .tooltip-content--rc {\n      left: 100%;\n      top: 50%;\n      transform: translate(0, -50%); }\n  .tooltip--inactive .tooltip-content {\n    display: none; }\n  .tooltip--light .tooltip-content {\n    background-color: white; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dropdown = function (_Component) {
	  ...
	  (0, _createClass3.default)(Dropdown, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(_index2.default, (0, _extends3.default)({ triggerType: 'click' }, this.props, { variant: 'dropdown' }));
	    }
	  }]);
	  return Dropdown;
	}(_react.Component);

	Dropdown.Trigger = _index2.default.Trigger;
	Dropdown.Content = _index2.default.Content;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Popup = function (_Component) {
	  ...
	  function Popup() {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Popup).apply(this, arguments));
	  }

	  (0, _createClass3.default)(Popup, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(_index2.default, (0, _extends3.default)({ triggerType: 'click', ignoreBlur: true }, this.props, { variant: 'popup' }));
	    }
	  }]);
	  return Popup;
	}(_react.Component);

	Popup.Trigger = _index2.default.Trigger;
	Popup.Content = _index2.default.Content;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js?importLoaders=1!./../node_modules/sass-loader/index.js!./index.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js?importLoaders=1!./../node_modules/sass-loader/index.js!./index.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
